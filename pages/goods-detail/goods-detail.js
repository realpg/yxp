...
Page({
  ...
  onLoad: function (e) {
    ...
    util.getGoodsDetails(param, function (res) {
      var content = res.data.ret.content
      if (content == null) {
        console.log("文章详情--------111-----" + JSON.stringify(res))
        vm.setData({
        ...
        //   var content = goodsDetail.content
        //   console.log("文章详情-------------" + JSON.stringify(content))
        // }
        // vm.setData({
        //   goods_details: res.data.ret,
        // })
        ...
        var goodDetail = res.data.ret
        console.log("商品详情信息 ： " + JSON.stringify(res))
        console.log("商品详情信息 0000： " + JSON.stringify(goodDetail.content))
        var content = goodDetail.content
        WxParse.wxParse('content', 'html', content, vm, 5);
        vm.setData({
          goods_details: goodDetail,
